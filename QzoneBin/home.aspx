<%@ Page Language="C#" AutoEventWireup="true" CodeFile="home.aspx.cs" Inherits="comment" %>
    ...
    <div>
         ...
         <div style ="height:100px;" >
            ...
            <asp:Label ID="lblHostGrade" runat="server" >label等级标签</asp:Label>
                                 ...
                                 <br /><asp:Label ID="LblAlldak" runat="server" >签到总天数</asp:Label>
                         <asp:Button ID="btndaka" runat ="server" Text ="签到" OnClick="btndaka_Click" />
                     </td>
                 </tr>
             </table>
        ...
        <div id="divmain">
            ...
            <div id="divquickSay" runat ="server" >
